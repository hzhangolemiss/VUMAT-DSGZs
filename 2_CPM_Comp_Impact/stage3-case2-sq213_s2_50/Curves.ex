...
# -- Velocity curve --
Plot_Velocity, yscale=1e-3, yname=$Velocity\ (m/s)$, legendlocate=topleft, Job-1_v1_n2_Fr.plot, Job-1_v1_n2_Bk.plot, Job-1_v1_n1_Ip.plot
...
# -- Stress curve --
Plot_Stress, yscale=1, yname=$Stress\ \sigma_{ii}\ (MPa)$, legendlocate=bottomright, Job-1_s11_e2_Fr.plot, Job-1_s11_e2_Bk.plot
