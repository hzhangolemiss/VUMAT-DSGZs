...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(6.8, 0.0), point2=(12.8, ydim)) # 6.0 mm metal Mlayer3
...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(12.8, 0.0), point2=(20.8, ydim)) # 8.0/16.0 mm polymer Mlayer2
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-MLayer2BLayer', positionToleranceMethod=COMPUTED,
