...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(1.6, 0.0), point2=(20.8, ydim)) # 16.2 mm metal Mlayer
mdb.models['Model-1'].Part(dimensionality=THREE_D, name='MLayer', type=DEFORMABLE_BODY)
mdb.models['Model-1'].parts['MLayer'].BaseSolidExtrude(depth=zdim, sketch=mdb.models['Model-1'].sketches['__profile__'])
del mdb.models['Model-1'].sketches['__profile__']
...
mdb.models['Model-1'].parts['MLayer'].Surface(name='Surf-MLayer-xlo', side1Faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#1 ]', ), ))
mdb.models['Model-1'].parts['MLayer'].Surface(name='Surf-MLayer-xhi', side1Faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#4 ]', ), ))
...
mdb.models['Model-1'].parts['MLayer'].Set(faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#1 ]', ), ), name='Set-MLayer-xlo')
mdb.models['Model-1'].parts['MLayer'].Set(faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#4 ]', ), ), name='Set-MLayer-xhi')
mdb.models['Model-1'].parts['MLayer'].Set(faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#8 ]', ), ), name='Set-MLayer-ylo')
mdb.models['Model-1'].parts['MLayer'].Set(faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#2 ]', ), ), name='Set-MLayer-yhi')
mdb.models['Model-1'].parts['MLayer'].Set(faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#20 ]', ), ), name='Set-MLayer-zlo')
mdb.models['Model-1'].parts['MLayer'].Set(faces=mdb.models['Model-1'].parts['MLayer'].faces.getSequenceFromMask(('[#10 ]', ), ), name='Set-MLayer-zhi')
mdb.models['Model-1'].parts['MLayer'].Set(cells=mdb.models['Model-1'].parts['MLayer'].cells.getSequenceFromMask(('[#1 ]', ), ), name='Set-MLayer')
...
mdb.models['Model-1'].HomogeneousSolidSection(material='mDSGZ-PC2015H', name='Section-MLayer', thickness=None)
mdb.models['Model-1'].parts['MLayer'].SectionAssignment(offset=0.0, offsetField='', offsetType=MIDDLE_SURFACE,
                                                        region=mdb.models['Model-1'].parts['MLayer'].sets['Set-MLayer'],
                                                        sectionName='Section-MLayer', thicknessAssignment=FROM_SECTION)
...
mdb.models['Model-1'].rootAssembly.Instance(dependent=ON, name='MLayer-Inst', part=mdb.models['Model-1'].parts['MLayer'])
...
mdb.models['Model-1'].HistoryOutputRequest(createStepName='Step-1', name='H-Output-6', numIntervals=h_out_n,
                                           rebar=EXCLUDE, region=mdb.models['Model-1'].rootAssembly.allInstances['MLayer-Inst'].sets['Set-MLayer'], sectionPoints=DEFAULT,
                                           variables=('ERV', 'DENSITY', 'LE11', 'MISES', 'PEEQ', 'S11', 'S22', 'SDV', 'TEMP', 'V1', 'U1'))
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-FLayerMLayer', positionToleranceMethod=COMPUTED,
                          slave=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].surfaces['Surf-MLayer-xlo'],
                          thickness=ON, tieRotations=ON)
mdb.models['Model-1'].Tie(adjust=ON,
                          master=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].surfaces['Surf-MLayer-xhi'],
                          name='Constraint-Tie-MLayerBLayer', positionToleranceMethod=COMPUTED,
...
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Initial', distributionType=UNIFORM, fieldName='', localCsys=None, name='BC-Impactor-zhi',
                                     ...
                                     u1=UNSET, u2=UNSET, u3=SET, ur1=SET, ur2=SET, ur3=SET)
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Initial', distributionType=UNIFORM, fieldName='', localCsys=None, name='BC-MLayer-ylo',
                                     region=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].sets['Set-MLayer-ylo'],
                                     u1=UNSET, u2=SET, u3=UNSET, ur1=SET, ur2=SET, ur3=SET)
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Initial', distributionType=UNIFORM, fieldName='', localCsys=None, name='BC-MLayer-yhi',
                                     region=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].sets['Set-MLayer-yhi'],
                                     u1=UNSET, u2=SET, u3=UNSET, ur1=SET, ur2=SET, ur3=SET)
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Initial', distributionType=UNIFORM, fieldName='', localCsys=None, name='BC-MLayer-zlo',
                                     region=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].sets['Set-MLayer-zlo'],
                                     u1=UNSET, u2=UNSET, u3=SET, ur1=SET, ur2=SET, ur3=SET)
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Initial', distributionType=UNIFORM, fieldName='', localCsys=None, name='BC-MLayer-zhi',
                                     region=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].sets['Set-MLayer-zhi'],
                                     u1=UNSET, u2=UNSET, u3=SET, ur1=SET, ur2=SET, ur3=SET)
...
mdb.models['Model-1'].Temperature(createStepName='Initial', crossSectionDistribution=CONSTANT_THROUGH_THICKNESS, distributionType=UNIFORM, magnitudes=(298.0, ),
                                  name='Predefined Field-Temp-MLayer', region=mdb.models['Model-1'].rootAssembly.instances['MLayer-Inst'].sets['Set-MLayer'])
...
mdb.models['Model-1'].parts['MLayer'].seedPart(deviationFactor=0.1, minSizeFactor=0.1, size=mesh_size)
mdb.models['Model-1'].parts['MLayer'].generateMesh()
mdb.models['Model-1'].parts['MLayer'].setElementType(
    elemTypes=(ElemType(elemCode=C3D8R, elemLibrary=EXPLICIT, secondOrderAccuracy=OFF, kinematicSplit=AVERAGE_STRAIN,
                        hourglassControl=DEFAULT, distortionControl=DEFAULT, elemDeletion=ON),
               ElemType(elemCode=C3D6, elemLibrary=EXPLICIT),
               ElemType(elemCode=C3D4, elemLibrary=EXPLICIT)),
    regions=(mdb.models['Model-1'].parts['MLayer'].cells.getSequenceFromMask(('[#1 ]', ), ), ))
