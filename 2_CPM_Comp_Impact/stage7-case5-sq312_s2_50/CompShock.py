...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(7.6, 0.0), point2=(8.2, ydim))
...
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(8.2, 0.0), point2=(12.2, ydim)) # 4.0 mm ceramic Mlayer1
...
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(12.2, 0.0), point2=(12.8, ydim))
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-MLayer3ACLayer1', positionToleranceMethod=COMPUTED,
