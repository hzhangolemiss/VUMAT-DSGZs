...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(1.6, 0.0), point2=(2.2, ydim))
...
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(2.2, 0.0), point2=(6.2, ydim)) # 4.0 mm ceramic Mlayer1
...
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(6.2, 0.0), point2=(6.8, ydim))
...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(6.8, 0.0), point2=(14.8, ydim)) # 8.0/16.0 mm polymer Mlayer2
...
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(14.8, 0.0), point2=(20.8, ydim)) # 6.0 mm metal Mlayer3
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-FLayerACLayer1', positionToleranceMethod=COMPUTED,
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-ACLayer2MLayer2', positionToleranceMethod=COMPUTED,
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-MLayer2MLayer3', positionToleranceMethod=COMPUTED,
...
mdb.models['Model-1'].Tie(adjust=ON,
                          ...
                          name='Constraint-Tie-MLayer3BLayer', positionToleranceMethod=COMPUTED,
