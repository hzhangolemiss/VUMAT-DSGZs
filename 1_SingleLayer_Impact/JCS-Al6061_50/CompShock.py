...
mdb.models['Model-1'].HomogeneousSolidSection(material='JCS-Al6061', name='Section-Flayer', thickness=None)
...
mdb.models['Model-1'].HistoryOutputRequest(createStepName='Step-1', name='H-Output-1', numIntervals=h_out_n,
                                           ...
                                           variables=('ERV', 'DENSITY', 'LE11', 'MISES', 'PEEQ', 'S11', 'S22', 'SDV', 'TEMP', 'V1'))
