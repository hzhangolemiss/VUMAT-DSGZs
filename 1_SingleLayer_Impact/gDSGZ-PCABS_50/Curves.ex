...
# -- Velocity curve --
Plot_Velocity, yscale=1e-3, yname=$Velocity\ (m/s)$, legendlocate=topleft, Job-1_v1_n1.plot

# -- Density curve --
#Plot_Density, yname=$Density\ \rho\ (ton/mm^3)$, legendlocate=topright, Job-1_density_e2.plot

# -- Stress curve --
Plot_Stress, yscale=1, yname=$Stress\ \sigma_{ii}\ (MPa)$, legendlocate=bottomright, Job-1_s11_e2.plot
...
Plot_VolumetricStrainRate, yscale=1, yname=$Volumetric\ Strain\ Rate\ (/s)$, legendlocate=topleft, Job-1_erv_e2.plot
